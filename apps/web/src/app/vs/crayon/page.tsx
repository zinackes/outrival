...
export const metadata: Metadata = {
  ...
  description:
    "Outrival vs Crayon, compared honestly. Crayon is a sales-led CI suite (median ~$28,750/yr, Vendr, July 2026); Outrival is self-serve from €0. See who each is for.",
