...
// can't half-theme it) and the footer in the dark region the landing ends on.
// The bar is not here — it lives inside <PageHero>, in flow, so the hero's fog
// runs behind it the way it does on the landing.
//
