...
// recharts is heavy + client-only: lazy-load the drill-down chart so it stays
// off the Trends route's first-load bundle (F7).
const TrendsDrillChart = dynamic(() => import("./trends-drill-chart"), {
  ssr: false,
