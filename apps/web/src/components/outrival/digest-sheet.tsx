  ...
  return (
    <>
      ...
      <div className="digest-sheet mx-auto max-w-[820px] px-8 py-12 sm:px-14">
        ...
        <h1 className="m-0 mt-7 max-w-[24em] text-[25px] font-semibold leading-[1.22] tracking-tight text-balance">
          ...
          <>
            ...
            {groups.map((group) => (
              <section key={group.urgency} className="mt-8">
                <h2 className="m-0 text-[11px] font-semibold uppercase tracking-[0.07em] text-[color:var(--sheet-faint)]">
        ...
        <footer className="mt-9 flex flex-wrap justify-between gap-3 border-t border-[color:var(--sheet-rule)] pt-3 text-[11px] text-[color:var(--sheet-faint)]">
          <span>
...
function Fact({
  ...
  return (
    <div className="flex flex-col gap-0.5">
      <dt className="text-[11px] uppercase tracking-[0.05em] text-[color:var(--sheet-faint)]">
        {label}
      </dt>
      <dd
