...
export function SignalSourceLine({ signalId, sourceType, detectedAt }: SignalSourceLineProps) {
  const [open, setOpen] = useState(false);

  return (
    <>
      <div className="flex flex-wrap items-center gap-x-1.5 gap-y-1 text-[13px] text-muted-foreground/70">
