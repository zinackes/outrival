...
// transition 150ms on the system ease-out curve. Press feedback = translateY(1px)
// on :active; focus ring 3px at Iris/35. Disabled drops to .4 opacity.
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-md text-sm font-medium whitespace-nowrap outline-none transition-all duration-[150ms] ease-out focus-visible:ring-[3px] focus-visible:ring-ring/35 active:translate-y-px disabled:pointer-events-none disabled:opacity-40 aria-invalid:border-destructive aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border border-border-strong bg-secondary text-secondary-foreground hover:bg-surface-3",
        ...
        // Link — Iris-on-dark text, no press shift.
        link: "text-link underline-offset-4 hover:underline active:translate-y-0",
      },
      size: {
