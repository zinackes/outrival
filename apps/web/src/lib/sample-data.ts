...
export function getSampleData(): { signals: Signal[]; competitors: Competitor[] } {
  ...
  const signals: Signal[] = [
    ...
    signal({
      ...
      soWhat: "They're building a partner-led motion — new routes to the accounts you sell to direct.",
    ...
    signal({
      ...
      competitorId: MERIDIAN,
      competitorName: "Meridian",
      insight: "New Capterra reviews flag Meridian's support response times as slow.",
