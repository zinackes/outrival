...
// Trigger.dev wrapper in ../jobs/detect-hiring-velocity-shifts.job.ts (deleted at
// the cutover). Only the header, the signature and the fan-out call change.
export async function runDetectHiringVelocityShifts(payload: z.input<typeof InputSchema>) {
