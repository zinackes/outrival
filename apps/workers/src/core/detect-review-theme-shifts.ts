...
// Trigger.dev wrapper in ../jobs/detect-review-theme-shifts.job.ts (deleted at
// the cutover). Only the header, the signature and the fan-out call change.
export async function runDetectReviewThemeShifts(payload: z.input<typeof InputSchema>) {
