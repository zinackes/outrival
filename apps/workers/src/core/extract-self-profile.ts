...
// Trigger.dev wrapper in ../jobs/extract-self-profile.job.ts (deleted at the cutover).
...
export async function runExtractSelfProfile(payload: z.input<typeof InputSchema>) {
