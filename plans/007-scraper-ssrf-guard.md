...
- `packages/scrapers/src/pricing/discover-url.ts:205-207,252-253` (two `fetch(url,{redirect:"follow"})`
  sites; #124 shifted them from the plan's original 113/159 — the file grew but still has exactly two)
